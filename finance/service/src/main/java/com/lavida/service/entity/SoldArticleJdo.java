...
@Table(name = "sold")
@NamedQueries({
        @NamedQuery(name = SoldArticleJdo.FIND_NOT_SOLD, query = "select a from SoldArticleJdo a where a.sold IS NULL"),
        @NamedQuery(name = SoldArticleJdo.FIND_SOLD, query = "select a from SoldArticleJdo a where a.sold IS NOT NULL")
})

public class SoldArticleJdo {
    public static final String FIND_NOT_SOLD = "SoldArticleJdo.findSold";
    public static final String FIND_SOLD = "SoldArticleJdo.findNotSold";
    ...
    public boolean equals(Object o) {
        ...
        SoldArticleJdo that = (SoldArticleJdo) o;
